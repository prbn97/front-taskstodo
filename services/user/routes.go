...
import (
	...
	"github.com/prbn97/tasklist/configs"
...
func (h *Handler) RegisterRoutes(router *mux.Router) {
	...
	router.HandleFunc("/register", h.userSingIn).Methods("POST")
...
func (h *Handler) userLogIn(w http.ResponseWriter, r *http.Request) {
	var user types.UserPayloadLogin
...
func (h *Handler) userSingIn(w http.ResponseWriter, r *http.Request) {
